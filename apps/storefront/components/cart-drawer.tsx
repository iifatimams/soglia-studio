  ...
  return (
    <div className="relative">
      <button
        ...
        className="h-10 font-mono text-xs uppercase tracking-meta text-oxblood"
      ...
      {isOpen ? (
        <div className="absolute end-0 top-11 z-20 w-[min(92vw,360px)] border border-rule bg-paper p-5 shadow-[0_18px_60px_rgba(27,26,24,0.12)]">
